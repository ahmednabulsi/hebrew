...
'time  zman  זמן': [27.8 * 1000 , 1.2 * 1000],
  ...
  'hummus  khu-mus  חומוס': [44.35 * 1000 , 1.2 * 1000],
  ...
  'store  kha-nut  חנות': [61.900000000000006 * 1000 , 1.2 * 1000],
  'lettuce  kha-sa  חסה': [63.25 * 1000 , 1.2 * 1000],
  ...
  'tasty  ta-im  טעים': [79.95 * 1000 , 1.2 * 1000],
 ...
 'Israel  is-ra-el  ישראל': [115.19999999999999 * 1000 , 1.2 * 1000],
